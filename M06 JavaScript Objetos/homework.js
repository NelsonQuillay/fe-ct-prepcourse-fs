...
function crearGato(nombre, edad) {
   ...
   //var gato = {nombre, edad, meow: () => 'Meow!'}; 
   return gato;  
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   //var nuevo = {nombre, email, password};
   
   //usando dot-notation y bracket-notation
   var nuevo = {}
   nuevo.nombre=nombre;
   nuevo['email']=email;
...
function agregarPropiedad(objeto, propiedad) {
   ...
   //no se puede usar dot-notation porque no la reconoce a la propiedad cuando esta dentro de una variable
   //objeto.propiedad=null;
   //se debe usar bracket-notation porque la propiedad esta en una variable y si la reconoce
   objeto [propiedad] = null;
   return objeto;
}
...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   objeto [metodo] ();
   //para ejecutar una funcion debe usar ()
}
